...
object cats {
   ...
   */
  def print[A](a: A)(implicit ev: Show[A], trace: ZTraceElement): ZIO[Has[Console], Nothing, Unit] =
   ...
   */
  def printLine[A](a: A)(implicit ev: Show[A], trace: ZTraceElement): ZIO[Has[Console], Nothing, Unit] =
